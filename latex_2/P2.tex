...
\begin{document}
	...
	\section{Results \& Discussions}
		...
		In figure \autoref{3d} and \autoref{slice}.
...
\begin{figure}
	\centering
	\includegraphics[width=0.9\textwidth]{images/border_segmentation1.png}
	\caption{Slice view of the segmented femur}
	\label{slice}
\end{figure}
\begin{figure}
	\centering
	\includegraphics[width=0.9\textwidth]{images/3dSegmentation.png}
