...
\begin{document}
	...
	It should be noted, that the probabilities of each 'update type' sum to one and the final mixture proposal first selects one of the two methods with the probability $0.5$.
	\begin{figure}
		\centering
